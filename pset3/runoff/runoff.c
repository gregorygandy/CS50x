...
bool vote(int voter, int rank, string name)
{
    for (int i = 0, n = candidate_count; i < n; i++) // candidate_count stores the number of candidates in the election
    {
...
void tabulate(void)
{
    ...
    {
        for (int j = 0, f = candidate_count; j < f; j++)
...
int find_min(void)
{
    ...
    for (int i = 0, f = candidate_count; i < f; i++)
    {
